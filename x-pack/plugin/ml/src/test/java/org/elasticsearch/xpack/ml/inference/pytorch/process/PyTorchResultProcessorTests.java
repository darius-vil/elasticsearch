...
public class PyTorchResultProcessorTests extends ESTestCase {
    ...
    public void testsTimeDependentStats() {
        ...
        // 1st period
        processor.processResult(wrapInferenceResult("foo0", false, 200L));
        processor.processResult(wrapInferenceResult("foo1", false, 200L));
        processor.processResult(wrapInferenceResult("foo2", false, 200L));
        ...
        // 2nd period
        processor.processResult(wrapInferenceResult("foo3", false, 100L));
        stats = processor.getResultStats();
        assertNotNull(stats.recentStats());
        ...
        // 4th period
        processor.processResult(wrapInferenceResult("foo4", false, 300L));
        stats = processor.getResultStats();
        assertNotNull(stats.recentStats());
        assertThat(stats.recentStats().requestsProcessed(), equalTo(1L));
        ...
        // 7th period
        processor.processResult(wrapInferenceResult("foo5", false, 410L));
        processor.processResult(wrapInferenceResult("foo6", false, 390L));
        stats = processor.getResultStats();
        assertThat(stats.recentStats().requestsProcessed(), equalTo(0L));
        assertThat(stats.recentStats().avgInferenceTime(), nullValue());
        ...
        // 8th period
        processor.processResult(wrapInferenceResult("foo7", false, 510L));
        processor.processResult(wrapInferenceResult("foo8", false, 500L));
        processor.processResult(wrapInferenceResult("foo9", false, 490L));
        stats = processor.getResultStats();
        assertNotNull(stats.recentStats());
        assertThat(stats.recentStats().requestsProcessed(), equalTo(3L));
